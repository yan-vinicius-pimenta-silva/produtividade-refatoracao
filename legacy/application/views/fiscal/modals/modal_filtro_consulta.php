<div class="modal fade" id="modal-data" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="form1" action="<?= base_url() ?>home/getAtividadesFiscalJSON" class="form-horizontal" method="POST">
				...
				<div class="modal-footer">
					<hr>
					<button type="button" id="btn_search" class="btn btn-success" data-dismiss="modal">CONSULTAR</button>
