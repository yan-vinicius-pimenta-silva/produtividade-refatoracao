			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<?php } else { ?>
					<div class="card">
						...
						<div class="body">
							<form id="form1" class="form-horizontal" action="<?= base_url() ?>usuario/cadastrar" method="POST">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label class="col-md-4 control-label" for="nivel">Ativo: </label>
								...
								<div class="form-group">
									<div class="col-sm-4">
										...
										<a href="./home" class="btn btn-default m-t-15 waves-effect">VOLTAR</a>
									</div>
								</div>
							</form>
						</div>
